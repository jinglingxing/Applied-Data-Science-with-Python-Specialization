...
ddd = (new_df['Gold'] - new_df['Gold.1'])/(new_df['Gold.2'])
ddd.argmax()
...
census_df = pd.read_csv('/Users/jinlingxing/dataScienceStudy/Introduction_data_science_by_python/census.csv')
census_df.head()
...
popular_counties_df = cen2010.groupby('STNAME').sum()
sort_df = popular_counties_df.sort_values('CENSUS2010POP', ascending = False) 
popular_counties = sort_df.head(3)
popular_counties.index.tolist()
